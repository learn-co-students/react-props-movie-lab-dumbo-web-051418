...
export default class MovieCard extends Component {
  ...
  render() {
    const backProp = {
      ...
      IMDBRating: this.props.movieProp.IMDBRating,
      genres: this.props.movieProp.genres
    };
    return (
      <div className="movie-card">
        <CardFront poster={posterMap[this.props.movieProp.poster]}/>
        <CardBack movie={backProp}/>
      </div>
    )
  }
}
